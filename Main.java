...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        // seeder
        playlists.push(new Playlist("Tasnaul Mustahil", "Humood Alkhuder"));
        playlists.push(new Playlist("be curious", "Humood Alkhuder"));
        playlists.push(new Playlist("Adu rayu", "yovie nuno & tulus"));
        // end seeder
